...
void indicator::canvasReplot_slot(void)
{
    update();
}
...
void indicator::paintEvent(QPaintEvent *)
{
    ...
    QBrush bgSky(QColor(107,165,216));
    QBrush bgGround(QColor(9,28,102));

    QPen   orangePen(QColor(255,102,0));
    QPen   bluPen(QColor(0,255,240));
    QPen   pitchPen(QColor(0,255,240));
    QPen   pitchZero(QColor(255,102,0));
