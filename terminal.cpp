...
void SettingsDialog::initialize(Ui::gravity *m_ui)
{
...
void SettingsDialog::showPortInfo(int idx,Ui::gravity *m_ui)
{
    if (idx == -1)
        return;
...
void SettingsDialog::apply(Ui::gravity *m_ui)
{
    updateSettings(m_ui);
//    hide();
}

void SettingsDialog::checkCustomBaudRatePolicy(int idx,Ui::gravity *m_ui)
{
...
void SettingsDialog::checkCustomDevicePathPolicy(int idx,Ui::gravity *m_ui)
{
...
void SettingsDialog::fillPortsParameters(Ui::gravity *m_ui)
{
...
void SettingsDialog::fillPortsInfo(Ui::gravity *m_ui)
{
...
void SettingsDialog::updateSettings(Ui::gravity *m_ui)
{
